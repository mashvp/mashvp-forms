...
function mashvp_forms__register_plugin__init(): void
{
...
function mashvp_forms__save_post($post_id): void
{
...
if (!function_exists('mvpf_render')) {
   ...
   * additional values.
   */
  function mvpf_render($id, $args = []): void
  {
...
/** ===== HOOKS ===== */
add_action('mvpf__submission_created', Email::handle(...), 10, 2);
