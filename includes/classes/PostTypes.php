...
class PostTypes extends SingletonClass
{
   ...
   * @return mixed[]
   */
  public function formPostAddColumns($columns): array
  {
    $clone = [];
  ...
  public function formPostRenderColumns($column, $post_id): void
  {
    if ($column === 'id') {
      echo $post_id;
    }
   ...
   * @return mixed[]
   */
  public function formSubmissionPostAddColumns($columns): array
  {
    $clone = [];
  ...
  public function formSubmissionPostRenderColumns($column, $post_id): void
  {
    ...
    if ($column === 'notifications') {
      ...
      echo sprintf('<div class="dashicons dashicons-email %s"></div>', $status);
    }
  }
}
