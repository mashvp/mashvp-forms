...
{
  public static function getAvailableExporterSettings(): array
  {
    return [
      'separator' => [
        'type' => 'select',
  ...
  public function echoHeaders(): void
  {
  ...
  private function echoCSV($fd, array $data): void
  {
    fputcsv($fd, $data, $this->getSetting('separator'));
  }

  private function generateHeader($fd, $field_ids, array $data): void
  {
  ...
  private function generatePrintableLine($fd, $field_ids, $entry): void
  {
  ...
  public function generateFile($data): void
  {
    $this->echoHeaders();
